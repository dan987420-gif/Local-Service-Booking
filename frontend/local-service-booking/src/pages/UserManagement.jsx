  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500 mt-1">Search, audit, and toggle login access permissions for all platform accounts.</p>
      </div>
                ...
                <tr key={u.userId} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="p-3.5 font-bold text-slate-900 flex items-center gap-2">
                    ...
                    <div>
                      ...
                      {u.role === 'Provider' && u.providerProfile && (
                        <span className="block text-[10px] text-teal-600 font-medium">{u.providerProfile.businessName}</span>
                      )}
                    </div>
                  </td>
                  ...
                  <td className="p-3.5">
                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide border ${
                      ...
                      u.role === 'Provider' ? 'bg-teal-50 text-teal-700 border-teal-100' :
                  ...
                  <td className="p-3.5 text-center">
                    ...
                    >
                      {u.isActive ? (
                        <ToggleRight className="w-8 h-8 text-indigo-600 mx-auto" />
                      ) : (
