  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-500">Submit government ID for background verification to unlock verified badge</p>
      </div>
      ...
      <div className="sc-card p-6 space-y-6">
        <div className="flex items-center gap-3 bg-indigo-50 p-4 rounded-xl border border-indigo-100">
          ...
          <div>
            <h4 className="text-xs font-bold text-indigo-900">Why Verification Matters</h4>
            <p className="text-[11px] text-indigo-700 mt-0.5">Verified providers receive 3x more customer bookings and display the trusted green badge.</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="border-2 border-dashed border-slate-200 rounded-xl p-6 text-center hover:border-indigo-400 transition-colors">
            ...
            <p className="text-xs font-semibold text-slate-700">Click to upload document or drag & drop</p>
